...
/**
 * @ORM\Entity(repositoryClass="App\Repository\PatchPanelImageRepository")
 * @Vich\Uploadable
 */
class PatchPanelImage
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\PatchPanel", inversedBy="patchPanelImages")
     */
    private $patchPanel;
