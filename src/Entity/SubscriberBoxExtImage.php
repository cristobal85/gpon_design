...
/**
 * @ORM\Entity(repositoryClass="App\Repository\SubscriberBoxExtImageRepository")
 * @Vich\Uploadable
 */
class SubscriberBoxExtImage
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\SubscriberBoxExt", inversedBy="images")
