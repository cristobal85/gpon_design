...
/**
 * @ORM\Entity(repositoryClass="App\Repository\SubscriberBoxExtPdfRepository")
 * @Vich\Uploadable
 */
class SubscriberBoxExtPdf
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\SubscriberBoxExt", inversedBy="subscriberBoxExtPdfs")
